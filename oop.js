...
let o3 = new MyObject('value', 'value2')
o3.prop2 = 'value3';
console.log(o3);
...
let o4 = new MyObject2('value', 'value2');
...
let o5 = new MyClass('value', 'value2');
console.log(o5.prop);
...
let o6 = new ChildClass('value', 'value2', 'value3');
console.log(o6);
...
let o7 = new ChildProto('value', 'value2', 'value3');
console.log(o7);
